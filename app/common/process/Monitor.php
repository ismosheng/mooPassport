...
class Monitor
{
     ...
     * @param string|list<string> $monitorDir Files and directories to monitor.
     * @param list<string> $monitorExtensions File suffixes that trigger reload.
     * @param array{enable_file_monitor?: bool, enable_memory_monitor?: bool, memory_limit?: int|string|null} $options
     */

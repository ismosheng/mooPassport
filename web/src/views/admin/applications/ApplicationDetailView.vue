...
.guide-layout{height:clamp(480px,calc(100dvh - 238px),760px);min-height:0;overflow:hidden}.guide-directory{position:static!important;max-height:none;overflow:hidden}.guide-content{height:100%;min-height:0;padding-right:5px;overflow-x:hidden;overflow-y:auto;scrollbar-gutter:stable}.guide-section{scroll-margin-top:8px}@media(max-width:900px){.guide-layout{height:auto;overflow:visible}.guide-content{height:auto;overflow:visible}}

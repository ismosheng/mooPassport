...
export const routes = [
  ...
  },
  {
    ...
    children: [
      { path: '', name: 'admin-dashboard', component: () => import('../views/admin/dashboard/DashboardView.vue'), meta: { title: '工作台', permission: 'admin.dashboard.read' } },
      { path: 'applications', name: 'admin-applications', component: () => import('../views/admin/applications/ApplicationsView.vue'), meta: { title: 'OAuth 应用', permission: 'admin.applications.read', fixedContent: true } },
      { path: 'applications/:id', name: 'admin-application-detail', component: () => import('../views/admin/applications/ApplicationDetailView.vue'), meta: { title: '应用详情', permission: 'admin.applications.read' } },
      { path: 'users', name: 'admin-users', component: () => import('../views/admin/users/UsersView.vue'), meta: { title: '用户管理', permission: 'admin.users.read', fixedContent: true } },
      { path: 'roles', name: 'admin-roles', component: () => import('../views/admin/roles/RolesView.vue'), meta: { title: '角色与权限', permission: 'admin.roles.read', fixedContent: true } },
      { path: 'audit', name: 'admin-audit', component: () => import('../views/admin/audit/AuditLogsView.vue'), meta: { title: '安全审计', permission: 'admin.audit.read', fixedContent: true } },
      { path: 'settings', name: 'admin-settings', component: () => import('../views/admin/settings/SettingsView.vue'), meta: { title: '系统设置', permission: 'admin.settings.read', fixedContent: true } },
    ],
  },

...
/**
 * Applies Chinese table and column comments without changing column definitions.
 *
 * The script reads each definition from SHOW CREATE TABLE before adding a
 * comment, which preserves indexes, defaults, precision and generated clauses.
 */
